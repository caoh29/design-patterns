...
class GasCar implements Vehicle {
  ...
  assemble(): void {
    console.log("Ensamblando auto de combustión");
  }
}
...
function mainAbsFact(factory: VehicleFactory) {
...
mainAbsFact(new ElectricVehicleFactory());

console.log('\nCreando vehículo de combustión:');
mainAbsFact(new GasVehicleFactory());